...
- 수동: 새 작업 시작 전 `wiki/README.md` 목차를 훑어보고 관련 주제 파일을 읽어달라고 요청한다.
- 자동화: 해당 프로젝트의 CLAUDE.md에 "X 작업 전에는 `<WIKI_REPO_PATH>/wiki/<topic>.md`를 참고하라"는 지침을 추가해두면, 세션마다 알아서 읽고 시작한다.
